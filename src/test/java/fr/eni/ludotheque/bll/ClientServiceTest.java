...
public class ClientServiceTest {
    ...
    public void testAjouterClientCasPositif() {
        ...
        assertThat(clientActual.getId()).isNotNull();
        assertThat(clientActual.getId()).isEqualTo(999L);
    ...
    public void testTrouverClientParIdCasIdIncconnu() {
        ...
        //Act + Assert
        assertThrows(ClientNotFoundException.class, ()->clientService.trouverClientParId(idClientRecherche) );
/*
		try{
